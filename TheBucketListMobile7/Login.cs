...
{
    [Activity(Label = "TheBucketList", MainLauncher = true)]
    public class Login : Activity
    {
        ...
        {
            url = "http://ec2-34-249-76-120.eu-west-1.compute.amazonaws.com/api/korisnik?username=" + username.Text + "&password=" + password.Text;
